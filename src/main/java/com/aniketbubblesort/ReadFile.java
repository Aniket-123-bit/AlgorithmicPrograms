...
public class ReadFile {
    ...
    public static ArrayList<Integer> readFile(){
        ...
        String data = " ";
        String filePath = "C:\\Users\\ac\\IdeaProjects\\I\\BubbleSort\\src\\main\\java\\com\\aniketbubblesort\\data";
        try {
            ...
            while (myReader.hasNextLine()){
                ...
                //spiltting the data into new line based on white space
